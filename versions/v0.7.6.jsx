...
// 9. Increases the text’s font size as much as possible (with a 10px safety margin at the bottom)
...
(function() {
    ...
    // We'll subtract an extra 10 pixels from the container's bottom to be safe.
    function maximizeFontSizeToFillTextBox(layer, containerX, containerY, containerWidth, containerHeight) {
        var bottomSafetyMargin = 10;  // Extra margin (in pixels) from the bottom edge.
