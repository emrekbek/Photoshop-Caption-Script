...
// 9. Auto-adjusts the font size so that all text fits within the text box and is as big as possible without overflowing.
(function() {
    ...
    // Font: Helvetica-BoldOblique, Font Size: 60px initial, Anti-Aliasing: Sharp, Color: white.
    ...
    // ---------- Auto-adjust the font size so that all text fits within the text box and is as big as possible.
    // This function uses a binary search approach followed by a fine-tuning loop using 0.5px increments.
    function adjustFontSizeToFillBox(layer, boxWidth, boxHeight, tolerance) {
        ...
        // Final vertical check: if the text still overflows vertically, reduce font size one pixel at a time.
        b = layer.bounds;
        renderedHeight = b[3].as("px") - b[1].as("px");
    ...
    adjustFontSizeToFillBox(textLayer, textWidth, textHeight, 0.5);
