...
// 9. Auto-adjusts the text size so that the text completely fills the textbox but does not overflow it.
(function() {
    ...
    // For anti-aliasing, we use the built-in enumeration if available; if not, we try a fallback string.
    try {
        ...
        try {
            ...
            // If this fails, you may need to set anti-aliasing manually.
        }
    }
    ...
    // ---------- Step 8. Auto-adjust the font size so that the text completely fills the text box without overflowing.
    // This function uses a binary search to find the maximum font size that fits within the text box.
