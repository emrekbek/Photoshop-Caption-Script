...
// 9. Auto-adjusts the font size so that all text is visible within the text box and is as big as possible.
(function() {
    ...
    // The following values are set for demonstration.
    // Change these values as needed.
    textLayer.textItem.font = "Helvetica-BoldOblique"; // Example font.
    textLayer.textItem.size = new UnitValue(60, "px");    // Initial font size.
    // Try to set anti-aliasing; if it fails, the script will continue.
    try {
        ...
        try {
            ...
            // If setting anti-aliasing fails, it will be left unchanged.
        }
    }
    ...
    // ---------- Step 8. Auto-adjust the font size so that all text fits inside the text box
    // and is as big as possible without overflowing.
    ...
    function adjustFontSizeToFillBox(layer, boxWidth, boxHeight, tolerance) {
        ...
        // Start with the current font size as the lower bound.
    ...
    // Final check: if the text still overflows vertically (e.g., bottom is cut off), reduce font size.
